...
namespace Jy.EntityFrameworkCore
{
    ...
    public class JyDbContext : DbContext, IUnitOfWork
    {
        public JyDbContext(DbContextOptions<JyDbContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //user role 多对多
            //var ur = builder.Entity<UserRole>();
            //ur.HasKey(p => new { p.UserId, p.RoleId });
            //ur.HasOne(p => p.User)
            ...
            ////role menu 多对多
            //var rm = builder.Entity<RoleMenu>();
            //rm.HasKey(p => new { p.RoleId, p.MenuId });
            //rm.HasOne(r => r.Role)
            //  .WithMany(r => r.RoleMenus)
            //  .HasForeignKey(r => r.RoleId);
            //rm.HasOne(m => m.Menu)
