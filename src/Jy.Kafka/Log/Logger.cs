...
namespace Jy.Kafka
{
    public class Logger : ILogger
    {
        public void LogDebug(string format, params object[] args)
        {
            ...
            Log.WriteLog("D:\\LogFiles_KafkaMQ\\", "Debug", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + content);
        }
        ...
        public void LogError(string message, Exception exception)
        {
            ...
            Log.WriteLog("D:\\LogFiles_KafkaMQ\\", "Error", sberr.ToString());
        }
        ...
        public void LogInformation(string format, params object[] args)
        {
            ...
            Log.WriteLog("D:\\LogFiles_KafkaMQ\\", "Info", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + content);
        }
        ...
        public void LogWarning(string format, params object[] args)
        {
            ...
            Log.WriteLog("D:\\LogFiles_KafkaMQ\\", "Warning", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + content);
        }
    }
}
