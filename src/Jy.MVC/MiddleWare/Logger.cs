...
namespace Jy.MVC
{
    public class Logger : ILogger
    {
        public void LogDebug(string format, params object[] args)
        {
            ...
            Log.WriteLog("D:\\LogFiles_WEB\\", "Debug", string.Format(format, args));
        }
        ...
        public void LogError(string message, Exception exception)
        {
            ...
            Log.WriteLog("D:\\LogFiles_WEB\\", "Error", sberr.ToString());
        }

        public void LogInformation(string format, params object[] args)
        {
            Console.WriteLine("Info:" + string.Format(format, args));
            Log.WriteLog("D:\\LogFiles_WEB\\", "Info", string.Format(format, args));
        }

        public void LogWarning(string format, params object[] args)
        {
            Console.WriteLine("Warning:" + string.Format(format, args));
            Log.WriteLog("D:\\LogFiles_WEB\\", "Warning", string.Format(format, args));
        }
    }
}
