...
namespace Jy.QueueSerivce
{
    public interface IQueueService
    {
        ...
        /// <param name="olddto">olddto</param>
        /// <param name="msg">要发送的消息</param>
        /// <param name="replyMsg">接收到的回执消息</param>
        /// <param name="succHandle">成功后的处理方法</param>
        /// <param name="runcnt">当前重试的次数，第一次填0</param>
        void Request<T>(T dto,T olddto, MessageBase msg, MessageBase replyMsg, Action<T,T, MessageBase> succHandle, int runcnt) where T : class;
    }
}
